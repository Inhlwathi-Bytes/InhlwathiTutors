...
namespace InhlwathiTutors.Migrations
{
    ...
    [Migration("20250520003152_bookings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InhlwathiTutors.Models.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InhlwathiTutors.Models.SubjectReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InhlwathiTutors.Models.SubjectReview", b =>
                {
                    b.HasOne("InhlwathiTutors.Models.SystemUser", "Reviewer")
                        .WithMany()
                        .HasForeignKey("ReviewerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InhlwathiTutors.Models.TutorshipSubject", "Subject")
                        .WithMany("Reviews")
            ...
            modelBuilder.Entity("InhlwathiTutors.Models.Tutorship", b =>
                {
                    ...
                    b.Navigation("TutorshipSubjects");
                });
